...
class KonachanWorker(BaseDownloader):
    ...
    async def scraper_task(self):
        ...
        while not self.stop_event.is_set() and (self.amount == 0 or collected_count < self.amount):
            try:
                ...
                resp = await asyncio.to_thread(self.session.get, "https://konachan.com/post.json", params={"tags": self.api_tag, "page": page, "limit": limit_val}, timeout=15)
